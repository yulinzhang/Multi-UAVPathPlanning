...
//    }
    private float[] randomGoalForThreat() {
        float[] random_goal_coordinate = new float[2];
        random_goal_coordinate[0] = (float) (Math.random() * this.bound_width);
        random_goal_coordinate[1] = (float) (Math.random() * this.bound_height);
